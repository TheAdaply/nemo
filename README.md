...
- Supermemory's new [Apache-2.0 Company Brain harness](https://github.com/supermemoryai/company-brain/tree/0071d6164991ce5dccddbd645bcac631ee477572) contains useful Slack participation, permission-scope and approval patterns, but its deployment requires a Supermemory memory-service key and a model-provider key. [#41](https://github.com/TheAdaply/nemo/issues/41) evaluates narrowly reusable pieces; the tested Nemo core does not depend on that service or copy its code.
